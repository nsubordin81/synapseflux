...
Instead, at least as we get started, I will focus on a few subjects that pique my own interest. For now that list is 
...
I hope to tackle these subjects from many learning approaches, with the hope of finding better ways to 
communicate their fundamentals while also determining the best way to make these and other concepts more digestible. 

Some ideas off the top of my head are: 
<ul>
    <li>to look to masters and polymaths who we tend to idolize for techniques </li>
    <li>to research our knowledge of how learning works for strategies to apply</li>
    <li>to perform rigorous practice and record my results,</li>
    <li>try to traverse as many avenues of existing inquiry into each of these subjects as is possible. </li>
</ul>
